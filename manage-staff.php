...
<html lang="en">
    <head>
        ...
        <title>MCA Admin| View Staff</title>
...
<li><button class="button button2" onclick="window.location.href = 'staff_import.php';"><i class="fa fa-plus"></i> Import</button></li>
<li><button  class="button button3" onclick="window.location.href = 'staff_add.php';"><i class="fa fa-edit"></i> Edit</button></li>
...
<div class="alert alert-success left-icon-alert" role="alert">
 <strong>Well done!</strong><?php echo htmlentities($msg1); ?>
    ...
    <div class="alert alert-danger left-icon-alert" role="alert">
                                            <strong>Oh snap!</strong> <?php echo htmlentities($error1); ?>
                                        </div>
                                        <?php } ?>
                                            <div class="panel-body p-20">
                                                ...
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
<?php $sql = "SELECT faculty.name,faculty.designation,faculty.mail_id from faculty";
...
<tr>
 <td><?php echo htmlentities($cnt);?></td>
                                                            ...
                                                            <td><?php echo htmlentities($result->mail_id);?></td>
