...
<div class="form-group">
 ...
 <div class="container">
   ...
   <div class="dropdown" weight=2px>
    <button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown">Select Import
    <span class="caret"></span></button>
    <ul class="dropdown-menu">
      <li><a tabindex="-1" href="stu_import_sem1">Semester 1</a></li>
      <li><a tabindex="-1" href="stu_import_sem2">Semester 2</a></li>
      <li><a tabindex="-1" href="stu_import_sem3">Semester 3</a></li>
      <li><a tabindex="-1" href="stu_import_sem4">Semester 4</a></li>
      <li><a tabindex="-1" href="stu_import_sem5">Semester 5</a></li>
      <li><a tabindex="-1" href="stu_import_sem6">Semester 6</a></li>
