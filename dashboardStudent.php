...
?>
 ...
 <?php 
  ...
  $query = "Select * from `sem3` t1 join `admin_login` t2 on t1.username = t2.username join `image` t3 on t2.username = t3.image_username  where t2.username = '$username' ";
    ...
    <div class="col-lg-3 col-sm-6">
          ...
          <div class="col-sm-6">
            <div class="row mgbt-xs-0"><br>
              <label class="col-xs-4 control-label">Sem</label>
          ...
          <div class="col-sm-6">
           ...
           <div class="col-sm-6">
            <div class="row mgbt-xs-0"><br>
              <label class="col-xs-4 control-label">Phone_no</label>
